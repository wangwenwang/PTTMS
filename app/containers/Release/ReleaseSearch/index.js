...
@connect(({ releaseSearch, router }) => ({ ...releaseSearch, router }))
@createForm()
class WaybillSearch extends Component {
  static navigationOptions = {
    ...
    reset = () => {
        Keyboard.dismiss()
        this.props.dispatch(createAction('releaseSearch/save')({
            startTime: null,
            endTime: null,
          ...
          <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps='always'>
              ...
              >
                  <DatePicker
                      ...
                      onChange={(val) => {
                          this.props.dispatch(createAction('releaseSearch/save')({ startTime: val }))
                          setFields({
                              startTime: { value: val }
                          })
                      }}
                  ...
                  <DatePicker
                      ...
                      onChange={(val) => {
                          this.props.dispatch(createAction('releaseSearch/save')({ endTime: val }))
                          setFields({
                              endTime: { value: val }
                          })
                      }}
                  ...
                  <Picker
                      ...
                      onChange={(val) => {
                          this.props.dispatch(createAction('releaseSearch/save')({ stateOrderStatus: val }))
                          setFields({
                              stateOrderStatus: { value: val }
                          })
                      }}
                  >
                      <List.Item arrow="horizontal">竞单状态</List.Item>
                  </Picker>
              </List>
              <WhiteSpace />
              <WhiteSpace />
              <View style={{ flexDirection: 'row' }}>
                  ...
                  <Button
                      ...
                      onClick={() => {
                          Keyboard.dismiss()
                          this.props.dispatch(NavigationActions.navigate({ routeName: 'Release', params: { searchValue: getFieldsValue() } }))
                      }}
                  >筛选</Button>
              </View>
              <WhiteSpace />
